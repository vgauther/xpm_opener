...
/*   Updated: 2019/11/21 19:10:51 by vgauther         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					find_color_for_pixel(t_data *data, char *c, char rvb,
					int x);
int					char_pixel_find(char *color_id, char *target, t_data *data,
					int x);
char				*create_save_to_protect_c(t_data *data, char *str);
